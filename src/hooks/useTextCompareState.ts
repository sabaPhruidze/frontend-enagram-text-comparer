...
const useTextCompareState = () => {
  ...
  useEffect(() => {
    ...
    const progressTimer = window.setInterval(() => {
      setProgressValue((currentProgress) => {
        ...
        const comparedResult = compareTexts(sourceText, targetText);
  ...
  }, [isComparing, sourceText, targetText]);
  ...
  return { handleCompare, handleReset, handleSwapTexts, hasCompared, isCompareEnabled, isComparing, isResetEnabled, leftSegments, progressValue, rightSegments, setSourceText, setTargetText, sourceText, targetText };
};
