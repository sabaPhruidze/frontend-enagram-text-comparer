...
const TextCompareMobileHeader = ({ isMenuOpen, onToggleMenu, onTriggerWidthChange, selectedTool }: TextCompareMobileHeaderProps) => {
  ...
  return (
    <header className="w-full bg-white md:overflow-hidden md:rounded-r-8">
      <div className="flex h-15 items-center justify-between bg-[#132450] px-5 md:h-12 md:rounded-tr-8 md:px-7">
      ...
      <button className="flex h-14 w-full cursor-pointer items-center border-b border-[#EDEDED] px-5 text-left md:h-18 md:rounded-br-8 md:px-7" onClick={onToggleMenu} type="button">
