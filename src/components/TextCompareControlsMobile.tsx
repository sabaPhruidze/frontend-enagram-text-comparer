  ...
  return (
    <section className="px-4 pb-4 pt-6">
      <div className="mx-auto flex w-72 flex-col gap-4">
        <LanguageDropdown onLanguageChange={onLanguageChange} selectedLanguage={selectedLanguage} />
        ...
        <button className={`flex h-10.5 items-center justify-center gap-1 rounded-md px-4 py-2.5 pl-3 ${isResetEnabled ? "cursor-pointer bg-[#466FE8]" : "cursor-not-allowed bg-[#383A4899]"}`} disabled={!isResetEnabled} onClick={onReset} type="button">
