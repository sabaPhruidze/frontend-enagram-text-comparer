...
const DiffTextView = ({ segments, placeholder }: DiffTextViewProps) => {
  return (
    <div className="h-47.5 w-full overflow-auto rounded-lg bg-[#F0F7FF] p-3 text-sm leading-5.5 text-[#383A48] lg:h-108 lg:p-4 lg:text-lg lg:leading-[1.625rem]">
      {segments.length === 0 ? (
        <span className="text-[#8E98A8] lg:text-[#383A48]/60">{placeholder}</span>
      ) : (
