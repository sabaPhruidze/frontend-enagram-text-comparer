  ...
  return (
    <section className="px-4 pb-6 pt-4">
      ...
      <div className="mx-auto flex w-72 flex-col items-center gap-4">
        <textarea
          className="h-47.5 w-full resize-none rounded-lg bg-[#F0F7FF] p-3 text-base leading-[1.375rem] text-[#383A48] outline-none placeholder:text-[#8E98A8]"
        ...
        <button
          className="mt-2 h-12 w-35.5 rounded-md bg-[#9598A3] px-4 py-2.5 text-lg leading-[1.375rem] font-normal text-white"
          type="button"
        >
          შედარება
        </button>
