...
const TextCompareWorkspaceMobile = ({ hasCompared, leftSegments, onCompare, onSourceTextChange, onSwapTexts, onTargetTextChange, rightSegments, sourceText, targetText }: TextCompareWorkspaceMobileProps) => {
  return (
